...
for g in genres:
    for k, filename in enumerate(os.listdir(f'/home/hwang-gyuhan/Workspace/dataset/fma_wav_pcm_echo/{g}')):
        songname = f'/home/hwang-gyuhan/Workspace/dataset/fma_wav_pcm_echo/{g}/{filename}'
        print(songname.ljust(85), "  i =  ", i, "/", total_file)
        filename3 = filename.split("_")[0] + "_PCM16_ECHO.wav"
        songname3= f'/home/hwang-gyuhan/Workspace/dataset/fma_wav_pcm_echo/{g}/{filename3}'
