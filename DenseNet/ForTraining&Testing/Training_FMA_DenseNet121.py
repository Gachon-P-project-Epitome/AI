...
class Train:
    def __init__(self,
                 train_data = "/home/hwang-gyuhan/Workspace/DenseNet/ForTraining&Testing/train_valid_data.csv",
    ...
    # train_data = Path to the *.CSV file -> the list of files for training and validation
    # train_img_path = Verify if CSV file is qualified
    ...
    for train_idx, val_idx in kfold.split(train_data):
        ...
        train_model(model_dense_121, train_generator, val_generator, train_steps, val_steps, nepoch, fold)
        print('========='*10)
